...
#define SCAMPER_PING_REPLY_IS_TCP(reply) (((reply)->reply_proto == 6))

#define SCAMPER_PING_REPLY_IS_UDP(reply) (((reply)->reply_proto == 17))
...
#define SCAMPER_PING_REPLY_FROM_TARGET(ping, reply)                          \
  ((SCAMPER_PING_METHOD_IS_ICMP_ECHO(ping) &&                                \
   ...
   (SCAMPER_PING_METHOD_IS_TCP(ping) && SCAMPER_PING_REPLY_IS_TCP(reply)) || \
