...
#define SCAMPER_DL_IS_IP(dl) ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_IP)

#define SCAMPER_DL_IS_IPV4(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_IP && (dl)->dl_af == AF_INET)

#define SCAMPER_DL_IS_IPV6(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_IP && (dl)->dl_af == AF_INET6)
...
#define SCAMPER_DL_IS_UDP(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_IP && (dl)->dl_ip_proto == 17)

#define SCAMPER_DL_IS_TCP(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_IP && (dl)->dl_ip_proto == 6)
...
#define SCAMPER_DL_IS_ARP(dl) ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_ARP)

#define SCAMPER_DL_IS_ARP_OP_REQ(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_ARP && (dl)->dl_arp_op == 1)

#define SCAMPER_DL_IS_ARP_OP_REPLY(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_ARP && (dl)->dl_arp_op == 2)

#define SCAMPER_DL_IS_ARP_HRD_ETHERNET(dl) \
  ((dl)->dl_net_type == SCAMPER_DL_REC_NET_TYPE_ARP && (dl)->dl_arp_hrd == 1)
