...
#define SCAMPER_ICMPEXT_IS_MPLS(ie) ((ie)->ie_cn == 1 && (ie)->ie_ct == 1)

#define SCAMPER_ICMPEXT_IS_UNNUMBERED(ie) ((ie)->ie_cn == 2)

#define SCAMPER_ICMPEXT_MPLS_COUNT(ie) ((ie)->ie_dl >> 2)
...
#define SCAMPER_ICMPEXT_MPLS_S(ie, x) ((ie)->ie_data[((x) << 2) + 2] & 0x1)

#define SCAMPER_ICMPEXT_MPLS_TTL(ie, x) ((ie)->ie_data[((x) << 2) + 3])

#define SCAMPER_ICMPEXT_UNNUMBERED_CT_ROLE(ie) ((ie)->ie_data[0] >> 6)
